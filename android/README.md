...
Откройте папку `android` в **Android Studio**. При первом открытии Studio предложит синхронизировать проект и скачать Gradle — подтвердите. Затем **Build → Make Project** или запуск на устройстве/эмуляторе.
